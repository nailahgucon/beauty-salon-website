...
<h2 style="color:white; text-align:center;"><?php echo $u;?>'s Profile</h2>
<br>
...
{
?>
<td><img src="<?php echo $one_item['profilepic']; ?>"></td>  
</tr> 
<th>&nbsp;Full Name&nbsp;</th> 
<td><?php echo $one_item['fullname']; ?></td>  
</tr> 
<th>&nbsp;Email&nbsp;</th> 
<td><?php echo $one_item['email']; ?></td>    
</tr> 
<th>&nbsp;Username&nbsp;</th> 
<td><?php echo $one_item['username']; ?></td>      
</tr> 
<th>&nbsp;Mobile Number&nbsp;</th> 
<td><?php echo $one_item['mobileno']; ?></td>   
<?php
}
?>
</tr> 
...
<br><br>
&nbsp;&nbsp;&nbsp;<input type="button" onclick="location.href='editprofile.php';" value="EDIT" style="background-color: white; color: black; padding: 10px;" />
<input type="button" onclick="location.href='editpassword.php';" value="CHANGE PASSWORD" style="background-color: white; color: black; padding: 10px;" />
<input type="button" onclick="location.href='editpic.php';" value="CHANGE AVATAR" style="background-color: white; color: black; padding: 10px;" />
</div>
